...
describe("SampleFascicleTable", () => {
  ...
  it("renders the correct number of rows according to the number of fascicle lengths", () => {
    vi.mocked(getFlattenedRenderObjects).mockReturnValue([
  ...
  it("renders the correct information within a row", () => {
    ...
    const { rerender } = render(<SampleFascicleTable />);
  ...
  it("dispatches the correct action when the visibility button is clicked", () => {
    ...
    expect(dispatchMock).toBeCalledWith(setVisibleFascicleLength(payload));
  });
  ...
  it("dispatches the correct action when the remove button is clicked", () => {
    ...
    expect(dispatchMock).toHaveBeenCalledOnce();
    expect(dispatchMock).toBeCalledWith(removeSampleFascicleLength(payload));
  });
});
